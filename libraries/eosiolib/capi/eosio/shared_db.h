...
/**
 *  @addtogroup shared_database_c_api Shared Database C API
 *  @ingroup c_api
 *  @brief Defines %C APIs for interfacing with the shared database.
 *  @details Shared Database C API provides low level interface to GAX database.
 *
...
/**
  ...
  *
  *  @code
  *  int32_t itr = shared_db_find_i64(receiver, receiver, table1, "alice"_n);
  *  eosio_assert(itr >= 0, "Alice cannot be removed since she was already not found in the table");
  *  shared_db_remove_i64(itr);
  *  @endcode
  */
__attribute__((eosio_wasm_import))
...
/**
  ...
  *  @code
  *  char value[50];
  *  auto len = shared_db_get_i64(itr, value, 0);
  *  eosio_assert(len <= 50, "buffer to small to store retrieved record");
  *  shared_db_get_i64(itr, value, len);
  *  @endcode
  */
__attribute__((eosio_wasm_import))
...
/**
  ...
  *
  *  @code
  *  int32_t charlie_itr = shared_db_find_i64(receiver, receiver, table1, "charlie"_n);
  *  // expect nothing after charlie
  *  uint64_t prim = 0
  *  int32_t  end_itr = shared_db_next_i64(charlie_itr, &prim);
...
/**
  ...
  *  @code
  *  uint64_t prim = 0;
  *  int32_t  itr_prev = shared_db_previous_i64(itr, &prim);
  *  @endcode
  */
__attribute__((eosio_wasm_import))
...
/**
  ...
  *
  *  @code
  *  int itr = shared_db_find_i64(receiver, receiver, table1, "charlie"_n);
  *  @endcode
  */
__attribute__((eosio_wasm_import))
...
/**
  ...
  */
__attribute__((eosio_wasm_import))
int32_t shared_db_idx256_store(uint64_t scope, capi_name table, capi_name payer, uint64_t id, const uint128_t* data, uint32_t data_len );
...
/**
  ...
  */
__attribute__((eosio_wasm_import))
void shared_db_idx256_update(int32_t iterator, capi_name payer, const uint128_t* data, uint32_t data_len);
...
/**
  ...
  */
__attribute__((eosio_wasm_import))
int32_t shared_db_idx256_find_primary(capi_name code, uint64_t scope, capi_name table, uint128_t* data, uint32_t data_len, uint64_t primary);
...
/**
  ...
  */
__attribute__((eosio_wasm_import))
int32_t shared_db_idx256_find_secondary(capi_name code, uint64_t scope, capi_name table, const uint128_t* data, uint32_t data_len, uint64_t* primary);
...
/**
  ...
  */
__attribute__((eosio_wasm_import))
int32_t shared_db_idx256_lowerbound(capi_name code, uint64_t scope, capi_name table, uint128_t* data, uint32_t data_len, uint64_t* primary);
...
/**
  ...
  */
__attribute__((eosio_wasm_import))
int32_t shared_db_idx256_upperbound(capi_name code, uint64_t scope, capi_name table, uint128_t* data, uint32_t data_len, uint64_t* primary);
